...
void RpcLibClientBase::writeLogMessage(const std::string& message, float x, float y, float z, float roll, float pitch, float yaw)
{
    pimpl_->client.call("writeLogMessage", message, x, y, z, roll, pitch, yaw);
}
