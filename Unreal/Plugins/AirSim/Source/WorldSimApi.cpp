...
void WorldSimApi::writeLogMessage(const std::string& message, float x, float y, float z, float roll, float pitch, float yaw)
{
    UAirBlueprintLib::writeLogMessage(message, x, y, z, roll, pitch, yaw);
}
